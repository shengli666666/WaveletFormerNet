...
parser.add_argument('--refine_model_dir',type=str,default='./trained_models/XXX.pk')
parser.add_argument('--model_dir',type=str,default='./trained_models/')
parser.add_argument('--trainset',type=str,default='nhhaze')
parser.add_argument('--testset',type=str,default='nhhaze')
